...
# Breast Cancer Analysis {.tabset}

## ASV Analysis

```{r}
identical(Breast_data$X, colnames(ASV_Breast))

BC_model_matrix <- model.matrix(~ Extraction_Number + Case.Control, Breast_data)
BC_clr <- aldex.clr(ASV_Breast, BC_model_matrix, mc.samples = 128)
BC_glm <- aldex.glm(BC_clr, BC_model_matrix)


saveRDS(BC_glm, "~/Private/CHAPTER_4/Retero/PATH/DA_Analysis/data/Breast/ASV_Aldex2.RDS")

BC_glm_ASV <- readRDS("~/Private/CHAPTER_4/Retero/PATH/DA_Analysis/data/Breast/ASV_Aldex2.RDS")
```
...
```{r}
# Genus testing
identical(Breast_data$X, colnames(Genus_Breast))

BC_clr_genus <- aldex.clr(Genus_Breast_filt, BC_model_matrix, mc.samples = 128)
BC_glm_genus <- aldex.glm(BC_clr_genus, BC_model_matrix)
saveRDS(BC_glm_genus, "~/Private/CHAPTER_4/Retero/PATH/DA_Analysis/data//Breast/Genus_Aldex2.RDS")


bc_glm_genus <- readRDS("~/Private/CHAPTER_4/Retero/PATH/DA_Analysis/data/Breast/Genus_Aldex2.RDS")
```

We want to control for extraction run so we will use the glm option in aldex!


# Prostate Cancer Analysis {.tabset}
...
Prostate_model_matrix <- model.matrix(~ Extraction_Number + Case.Control, Prostate_data)
Prostate_clr <- aldex.clr(ASV_Prostate, Prostate_model_matrix, mc.samples = 128)
Prostate_glm <- aldex.glm(Prostate_clr, Prostate_model_matrix)
saveRDS(Prostate_glm, "~/Private/CHAPTER_4/Retero/PATH/DA_Analysis/data/Prostate/ASV_Aldex2.RDS")

glm_prostate_asv <- readRDS("~/Private/CHAPTER_4/Retero/PATH/DA_Analysis/data/Prostate/ASV_Aldex2.RDS")

glm_prostate_asv %>% arrange(`model.Case.ControlCase Pr(>|t|).BH`) %>% head(n=5) %>% select(c(`model.Case.ControlCase Pr(>|t|).BH`, `model.Case.ControlCase Pr(>|t|)`, `model.Case.ControlCase Estimate`)) %>% kable() %>% kable_styling()
...
identical(Prostate_data$X, colnames(Genus_Prostate_filt))

Prostate_genus_clr <- aldex.clr(Genus_Prostate, Prostate_model_matrix, mc.samples = 128)
Prostate_genus_glm <- aldex.glm(Prostate_genus_clr, Prostate_model_matrix)
saveRDS(Prostate_genus_glm, "~/Private/CHAPTER_4/Retero/PATH/DA_Analysis/data/Prostate/Genus_Aldex2.RDS")

glm_prostate_genus <- readRDS("~/Private/CHAPTER_4/Retero/PATH/DA_Analysis/data/Prostate/Genus_Aldex2.RDS")

glm_prostate_genus %>% arrange(`model.Case.ControlCase Pr(>|t|).BH`) %>% head(n=5) %>% select(c(`model.Case.ControlCase Pr(>|t|).BH`, `model.Case.ControlCase Pr(>|t|)`, `model.Case.ControlCase Estimate`)) %>% kable() %>% kable_styling()
```
...
CRC_clr <- aldex.clr(ASV_CRC, CRC_model_matrix, mc.samples = 128)
CRC_glm <- aldex.glm(CRC_clr, CRC_model_matrix)
saveRDS(CRC_glm, "~/Private/CHAPTER_4/Retero/PATH/DA_Analysis/data/Colon/ASV_Aldex2.RDS")


CRC_glm_ASV <- readRDS("~/Private/CHAPTER_4/Retero/PATH/DA_Analysis/data/Colon/ASV_Aldex2.RDS")

CRC_glm_ASV %>% arrange(`model.Case.ControlCase Pr(>|t|).BH`) %>% head(n=5) %>% select(c(`model.Case.ControlCase Pr(>|t|).BH`, `model.Case.ControlCase Pr(>|t|)`, `model.Case.ControlCase Estimate`)) %>% kable() %>% kable_styling()
...
# 
# 
identical(CRC_data$X, colnames(Genus_CRC_filt))

CRC_genus_clr <- aldex.clr(Genus_CRC, CRC_model_matrix, mc.samples = 128)
CRC_genus_glm <- aldex.glm(CRC_genus_clr, CRC_model_matrix)
saveRDS(CRC_genus_glm, "~/Private/CHAPTER_4/Retero/PATH/DA_Analysis/data/Colon/Genus_Aldex2.RDS")

CRC_glm_genus <- readRDS("~/Private/CHAPTER_4/Retero/PATH/DA_Analysis/data/Colon/Genus_Aldex2.RDS")

CRC_glm_genus %>% arrange(`model.Case.ControlCase Pr(>|t|).BH`) %>% head(n=5) %>% select(c(`model.Case.ControlCase Pr(>|t|).BH`, `model.Case.ControlCase Pr(>|t|)`, `model.Case.ControlCase Estimate`)) %>% kable() %>% kable_styling()
```
