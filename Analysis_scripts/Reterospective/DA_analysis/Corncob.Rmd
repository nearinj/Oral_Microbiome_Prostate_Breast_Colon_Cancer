...
saveRDS(Breast_case, "~/Private/CHAPTER_4/Retero/PATH/DA_Analysis/data/Breast/ASV_Corncob.RDS")
```

## Genus

```{r}
OTU <- phyloseq::otu_table(Genus_Breast, taxa_are_rows = T)
sampledata <- phyloseq::sample_data(Breast_data, errorIfNULL = T)
phylo <- phyloseq::merge_phyloseq(OTU, sampledata)
...
saveRDS(Genus_Breast_Case, "~/Private/CHAPTER_4/Retero/PATH/DA_Analysis/data/Breast/Genus_Corncob.RDS")
```
...
saveRDS(ASV_Prostate_Case, "~/Private/CHAPTER_4/Retero/PATH/DA_Analysis/data/Prostate/ASV_Corncob.RDS")
```
...
OTU <- phyloseq::otu_table(Genus_Prostate, taxa_are_rows = T)
sampledata <- phyloseq::sample_data(Prostate_data, errorIfNULL = T)
phylo <- phyloseq::merge_phyloseq(OTU, sampledata)
...
saveRDS(Genus_Prostate_Case, "~/Private/CHAPTER_4/Retero/PATH/DA_Analysis/data/Prostate/Genus_Corncob.RDS")
```
...
OTU <- phyloseq::otu_table(ASV_CRC, taxa_are_rows = T)
...
saveRDS(ASV_CRC_test, "~/Private/CHAPTER_4/Retero/PATH/DA_Analysis/data/Colon/ASV_Corncob.RDS")
```

## Genus
```{r CRC_Analysis}

OTU <- phyloseq::otu_table(Genus_CRC, taxa_are_rows = T)
sampledata <- phyloseq::sample_data(CRC_data, errorIfNULL = T)
phylo <- phyloseq::merge_phyloseq(OTU, sampledata)
...
saveRDS(Genus_CRC_test, "~/Private/CHAPTER_4/Retero/PATH/DA_Analysis/data/Colon/Genus_Corncob.RDS")
```
