...
PATH_alpha[[2]] + theme_cowplot() + theme(text=element_text(size=14)) + theme(legend.position = "none")
ATP_alpha[[2]] + theme_cowplot() + theme(text=element_text(size=14)) + theme(legend.position = "none")
```
