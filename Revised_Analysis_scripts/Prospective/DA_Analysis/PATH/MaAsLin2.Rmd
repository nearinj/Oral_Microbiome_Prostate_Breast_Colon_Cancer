...
Breast_Cancer_ASV <- Maaslin2(input_data = Breast_ASV,
...
saveRDS(Breast_Cancer_ASV$results, "~/Private/CHAPTER_4/Prospec/PATH/Data/Breast/ASV_maaslin2.RDS")
```
...
Breast_Cancer_Genera <- Maaslin2(input_data = Breast_Genera,
                              input_metadata = Breast_data,
                              output=Output, 
                              min_abundance = 0,
                              min_prevalence = 0,
...
saveRDS(Breast_Cancer_Genera, "~/Private/CHAPTER_4/Prospec/PATH/Data/Breast/Genera_maaslin2.RDS")
```
...
Prostate_Cancer_ASV <- Maaslin2(input_data = Prostate_ASV,
...
saveRDS(Prostate_Cancer_ASV, "~/Private/CHAPTER_4/Prospec/PATH/Data/Prostate/ASV_maaslin2.RDS")
```
...
Prostate_Cancer_Genera <- Maaslin2(input_data = Prostate_Genera,
                              input_metadata = Prostate_data,
                              output=Output, 
                              min_abundance = 0,
                              min_prevalence = 0,
...
saveRDS(Prostate_Cancer_Genera, "~/Private/CHAPTER_4/Prospec/PATH/Data/Prostate/Genera_maaslin2.RDS")
```
# Colon Cancer
...
Colon_Cancer_ASV <- Maaslin2(input_data = CRC_ASV,
...
saveRDS(Colon_Cancer_ASV, "~/Private/CHAPTER_4/Prospec/PATH/Data/Colon/ASV_maaslin2.RDS")
```
...
Colon_Cancer_Genera <- Maaslin2(input_data = CRC_Genera,
                              input_metadata = CRC_data,
                              output=Output, 
                              min_abundance = 0,
                              min_prevalence = 0,
...
saveRDS(Colon_Cancer_Genera, "~/Private/CHAPTER_4/Prospec/PATH/Data/Colon/Genera_maaslin2.RDS")
```
