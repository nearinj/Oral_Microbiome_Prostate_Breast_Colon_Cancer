...
sampledata <- phyloseq::sample_data(as.data.frame(Breast_data), errorIfNULL = T)
...
saveRDS(Breast_ASV_test, "~/Private/CHAPTER_4/Prospec/PATH/Data/Breast/ASV_corncob.RDS")
```

## Genera
```{r}
OTU <- phyloseq::otu_table(Breast_Genera, taxa_are_rows = T)
...
saveRDS(Breast_genera_test, "~/Private/CHAPTER_4/Prospec/PATH/Data/Breast/Genera_corncob.RDS")
```
...
OTU <- phyloseq::otu_table(CRC_ASV, taxa_are_rows = T)
...
saveRDS(Colon_ASV_test, "~/Private/CHAPTER_4/Prospec/PATH/Data/Colon/ASV_corncob.RDS")
```

## Genera

```{r}
OTU <- phyloseq::otu_table(CRC_Genera, taxa_are_rows = T)
sampledata <- phyloseq::sample_data(CRC_data, errorIfNULL = T)
phylo <- phyloseq::merge_phyloseq(OTU, sampledata)
...
saveRDS(Colon_Genera_test, "~/Private/CHAPTER_4/Prospec/PATH/Data/Colon/Genera_corncob.RDS")
```
...
saveRDS(Prostate_ASV_test, "~/Private/CHAPTER_4/Prospec/PATH/Data/Prostate/ASV_corncob.RDS")
```

## Genera

```{r}
OTU <- phyloseq::otu_table(Prostate_Genera, taxa_are_rows = T)
sampledata <- phyloseq::sample_data(Prostate_data, errorIfNULL = T)
phylo <- phyloseq::merge_phyloseq(OTU, sampledata)
...
saveRDS(Prostate_Genera_test, "~/Private/CHAPTER_4/Prospec/PATH/Data/Prostate/Genera_corncob.RDS")
```