...
```{r}
Breast_ASV_aldex <- readRDS("~/Private/CHAPTER_4/Revised_data/DA/PATH_Retro/Breast/ASV_ALDEX2.RDS")
Breast_ASV_ancom <- readRDS("~/Private/CHAPTER_4/Revised_data/DA/PATH_Retro/Breast/ASV_ANCOM.RDS")
Breast_ASV_corncob <- readRDS("~/Private/CHAPTER_4/Revised_data/DA/PATH_Retro/Breast/ASV_Corncob.RDS")
Breast_ASV_maaslin2 <- readRDS("~/Private/CHAPTER_4/Revised_data/DA/PATH_Retro/Breast/ASV_MAASLIN2.RDS")

Breast_GENUS_aldex <- readRDS("~/Private/CHAPTER_4/Revised_data/DA/PATH_Retro/Breast/Genus_ALDEX2.RDS")
Breast_GENUS_ancom <- readRDS("~/Private/CHAPTER_4/Revised_data/DA/PATH_Retro/Breast/Genus_ANCOM.RDS")
Breast_GENUS_corncob <- readRDS("~/Private/CHAPTER_4/Revised_data/DA/PATH_Retro/Breast/Genus_Corncob.RDS")
Breast_GENUS_maaslin2 <- readRDS("~/Private/CHAPTER_4/Revised_data/DA/PATH_Retro/Breast/Genus_MAASLIN2.RDS")
```

## Prostate

```{r}
Prostate_ASV_aldex <- readRDS("~/Private/CHAPTER_4/Revised_data/DA/PATH_Retro/Prostate/ASV_ALDEX2.RDS")
Prostate_ASV_ancom <- readRDS("~/Private/CHAPTER_4/Revised_data/DA/PATH_Retro/Prostate/ASV_ANCOM.RDS")
Prostate_ASV_corncob <- readRDS("~/Private/CHAPTER_4/Revised_data/DA/PATH_Retro/Prostate/ASV_Corncob.RDS")
Prostate_ASV_maaslin2 <- readRDS("~/Private/CHAPTER_4/Revised_data/DA/PATH_Retro/Prostate/ASV_MAASLIN2.RDS")

Prostate_GENUS_aldex <- readRDS("~/Private/CHAPTER_4/Revised_data/DA/PATH_Retro/Prostate/Genus_ALDEX2.RDS")
Prostate_GENUS_ancom <- readRDS("~/Private/CHAPTER_4/Revised_data/DA/PATH_Retro/Prostate/Genus_ANCOM.RDS")
Prostate_GENUS_corncob <- readRDS("~/Private/CHAPTER_4/Revised_data/DA/PATH_Retro/Prostate/Genus_Corncob.RDS")
Prostate_GENUS_maaslin2 <- readRDS("~/Private/CHAPTER_4/Revised_data/DA/PATH_Retro/Prostate/Genus_MAASLIN2.RDS")
...
```{r}
Colon_ASV_aldex <- readRDS("~/Private/CHAPTER_4/Revised_data/DA/PATH_Retro/CRC/ASV_ALDEX2.RDS")
Colon_ASV_ancom <- readRDS("~/Private/CHAPTER_4/Revised_data/DA/PATH_Retro/CRC/ASV_ANCOM.RDS")
Colon_ASV_corncob <- readRDS("~/Private/CHAPTER_4/Revised_data/DA/PATH_Retro/CRC/ASV_Corncob.RDS")
Colon_ASV_maaslin2 <- readRDS("~/Private/CHAPTER_4/Revised_data/DA/PATH_Retro/CRC/ASV_MAASLIN2.RDS")

Colon_GENUS_aldex <- readRDS("~/Private/CHAPTER_4/Revised_data/DA/PATH_Retro/CRC/Genus_ALDEX2.RDS")
Colon_GENUS_ancom <- readRDS("~/Private/CHAPTER_4/Revised_data/DA/PATH_Retro/CRC/Genus_ANCOM.RDS")
Colon_GENUS_corncob <- readRDS("~/Private/CHAPTER_4/Revised_data/DA/PATH_Retro/CRC/Genus_Corncob.RDS")
Colon_GENUS_maaslin2 <- readRDS("~/Private/CHAPTER_4/Revised_data/DA/PATH_Retro/CRC/Genus_MAASLIN2.RDS")
...
filt_non_sig_est <- function(pvals, ests, pval_thres){
  stopifnot(identical(pvals$feature, ests$feature))
  ret_ests <- ests
...
test <- heatmap_function(abund=Full_Colon_Data, pval=Rename_Sig_Colon_ASV, est=Rename_Sig_Colon_ASV_est,
                         gradient = seq(-5, 0, by=0.1), main = "Colon", show_row = T, show_legend = T, log = T, display_vals = T)
...
Sanity checks
```{r}
head(sort(Breast_ASV_aldex$`model.Case.ControlCase Pr(>|t|).BH`))
Breast_ASV_ancom$out %>% filter(detected_0.7==TRUE)
Breast_ASV_corncob$significant_taxa
##these values would have changed with filter of taxa and then readjustment of p-values
Breast_ASV_maaslin2 %>% filter(qval < 0.05)

Prostate_ASV_aldex %>% filter(`model.Case.ControlCase Pr(>|t|).BH` < 0.05)
Prostate_ASV_ancom$out %>% filter(detected_0.7==TRUE)
Prostate_ASV_corncob$significant_taxa
Prostate_ASV_maaslin2 %>% filter(qval < 0.05)

Colon_ASV_aldex %>% filter(`model.Case.ControlCase Pr(>|t|).BH` < 0.05)
#check this one..
Colon_ASV_ancom$out %>% filter(detected_0.7==TRUE)
Colon_ASV_maaslin2 %>% filter(qval < 0.05)
```
...
sanity checks
```{r}
Breast_GENUS_aldex %>% filter(`model.Case.ControlCase Pr(>|t|).BH` < 0.05)
Breast_GENUS_ancom$out %>% filter(detected_0.7==TRUE)
Breast_GENUS_corncob$significant_taxa
Breast_GENUS_maaslin2 %>% filter(qval < 0.05)

Prostate_GENUS_aldex %>% filter(`model.Case.ControlCase Pr(>|t|).BH` < 0.05)
Prostate_GENUS_ancom$out %>% filter(detected_0.7==TRUE)
Prostate_GENUS_corncob$significant_taxa
Prostate_GENUS_maaslin2 %>% filter(qval < 0.05)

Colon_GENUS_aldex %>% filter(`model.Case.ControlCase Pr(>|t|).BH` < 0.05)
Colon_GENUS_ancom$out %>% filter(detected_0.7==TRUE)
Colon_GENUS_corncob$significant_taxa
Colon_GENUS_maaslin2 %>% filter(qval < 0.05)
```

# Individual plots for each taxa

Use these to sanity check the heatmap.
...
Comb_Genera_plots
saveRDS(Comb_Genera_plots, "~/Private/CHAPTER_4/Revised_Figures/RDS/ret_path_DA_genera_indiv_plots.rds")
```
...
saveRDS(Comb_ASV_plots, "~/Private/CHAPTER_4/Revised_Figures/RDS/ret_path_DA_ASV_indiv_plots.rds")
```


Fusobacterium periodonticum plot
```{r}
names(Comb_ASV_plots)

Fuso_asv_plot <- Comb_ASV_plots[[4]] + ggtitle("Fusobacterium periodonticum")

ggsave("~/Private/CHAPTER_4/Revised_Figures/Display_items/Supplemental/Fuso_perio_retro.pdf",
       width=7, height=7)
```

```{r}
fd <- Full_Prostate_data_genera[,c("Case.Control", Sig_Prostate_Genus$feature)] %>% group_by(Case.Control) %>% summarize_if(is.numeric, mean) %>% melt() #%>% summarize(value=value[Case.Control=="Case"]/value[Case.Control=="Control"])

fc_pro <- fd %>% summarize(fc=value[Case.Control=="Case"]/value[Case.Control=="Control"])
...
```{r}
fd <- Full_Prostate_data[,c("Case.Control",Rename_Sig_Prostate_ASV$feature)] %>% group_by(Case.Control) %>% summarize_if(is.numeric, mean) %>% melt()
...
for(i in 1:length(fc_pro$fc)){
  if(is.na(fc_pro$fc[i])){
    ...
    fc_pro$fc_2[i] <- 1/fc_pro$fc[i]
  }

  
}

max(c(fc_pro[,1], fc_pro[,2]), na.rm=T)
fc_pro
```
